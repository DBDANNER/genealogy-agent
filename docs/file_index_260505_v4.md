# Ancestry Project File Index — 260505 v4
...
### File index
`docs/file_index_260505_v4.md`

This file.

### GitHub write playbook
`docs/github_write_playbook_260505_v2.md`

Preferred workflow for writing generated governing/reference files into GitHub using local CMD/Git, with connector reads used for verification. v2 records the two-shape CMD pattern: use a one-time clone/setup command only when needed, then use an existing-folder push command for normal file updates. Do not put the full copy/commit/push workflow behind an `if not exist ... git clone ...` conditional.
...
5. For GitHub governing-file writes, prefer local CMD/Git writes followed by connector verification. Direct connector writes may be slow or fail after permission prompts. See `docs/github_write_playbook_260505_v2.md`.
...
3. `docs/file_index_260505_v4.md`
...
Read:
1. `docs/github_write_playbook_260505_v2.md`
2. `docs/file_index_260505_v4.md`
