# Ancestry Project File Index — 260413 v1
...
Examples:
- `00_start_here_260413_v1.md`
- `file_index_260413_v1.md`
...
`docs/00_start_here_260413_v1.md`
...
Purpose:
Validated slotmaps and minitrees are renamed with seed-ancestor names and preserved in a human-readable destination in the operational repo.
...
Start with:
1. `docs/00_start_here_260413_v1.md`
2. latest continuity file
3. `docs/file_index_260413_v1.md`
