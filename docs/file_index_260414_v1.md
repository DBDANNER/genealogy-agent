# Ancestry Project File Index — 260414 v1
...
3. `docs/file_index_260414_v1.md`

Correction:
The governing startup file now standardizes the intended real-world order as:
1. startup file
2. governing file index
3. continuity file
...
1. `docs/00_start_here_260414_v1.md`
2. `docs/file_index_260414_v1.md`
