# Ancestry Project — Start Here — 260415 v1
...
1. the most recent governing `00_start_here_*` file
2. the most recent governing `file_index_*` file
...
2. read the governing file index
...
1. `docs/shuttle_messages_260412.md` and `docs/navigator_manual_260412.md` still use date-only names and should be treated as implicit `v1` unless superseded
...
Working rule:
- governing startup and index pointers should usually use full repo-qualified GitHub-style paths
...
## Current governing companions
The governing file index paired with this startup file is:
- `DBDANNER/genealogy-agent/docs/file_index_260415_v1.md`
