# Ancestry Project File Index — 260426 v1
...
- `docs/00_start_here_260416_v1.md`

### File index family
Current governing file index:
- `docs/file_index_260426_v1.md`
...
- `docs/navigator_manual_260426_v1.md`
...
1. `docs/00_start_here_260416_v1.md`
2. `docs/file_index_260426_v1.md`
...
1. `docs/shuttle_messages_260412.md` still uses a date-only name and should be treated as implicit `v1`
...
6. bad harvest recovery for collapsed page sections is now documented in the current governing Navigator manual rather than continuity only
...
Start with:
1. `docs/navigator_manual_260426_v1.md`
...
### If the user wants bad-harvest recovery
Start with:
1. `docs/navigator_manual_260426_v1.md`
2. identify the affected PID/time window
3. remove the corresponding bad artifacts from raw, merged, and `people`
4. validate one corrected rerun before continuing the rest of the batch
